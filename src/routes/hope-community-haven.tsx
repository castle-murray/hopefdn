...
export const Route = createFileRoute("/hope-community-haven")({
  component: HopeCommunityHavenPage,
  head: () => ({
    meta: [{ title: "Hope Community Haven | H.O.P.E. Foundation" }],
  }),
});

function HopeCommunityHavenPage() {
  return (
    <>
      <PageHero
        eyebrow="Hope Community Haven"
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="overflow-hidden rounded-2xl shadow-[var(--shadow-elevated)]">
            <img
              ...
              srcSet="/images/resource-center-w800.webp 800w, /images/resource-center-w1200.webp 1200w"
          ...
          <div>
            ...
            <p className="mt-5 text-base leading-relaxed text-muted">
              ...
              without a dedicated campus. Hope Community Haven will anchor our
      ...
      <section className="bg-cream/70 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-3xl font-semibold text-navy">
            Services the Haven will expand
          </h2>
